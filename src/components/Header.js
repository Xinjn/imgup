...
const Compenent = observer(() => {
    ...
    return (
        <Header>
            ...
            <LogoWrapper>
                <NavLink to="/">
                    {/* <img src="https://z3.ax1x.com/2021/06/10/2R5WMn.png" alt="2R5WMn.png" border="0" /> */}
                    <img src="https://z3.ax1x.com/2021/06/14/2TGi38.png" alt="2TGi38.png" border="0" />
                    {/* <img src="https://z3.ax1x.com/2021/06/14/2TGEuQ.png" alt="2TGEuQ.png" border="0" /> */}
                </NavLink>
            </LogoWrapper>
                ...
                <Login> 
                    {
                        UserStore.currentUser ? <>
                            ...
                            <StyledLink to="/history" activeClassName="active">{t('历史')}</StyledLink>
                            <StyledLink to="">
                                        <svg className="icon" aria-hidden="true">
                            ...
                            <StyledButton type="primary" onClick={handleLogout}>{t('注销')}</StyledButton>
                            <StyledLink to="/about" activeClassName="active">{t('关于')}
